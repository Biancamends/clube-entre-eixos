# 8943aaa5-bf7a-4aea-b9f2-c16601df4f2e implementation handoff

This archive is the source of truth for turning the design into production code. Start from `entre-eixos.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `entre-eixos.html`
...
- A single self-contained `entre-eixos.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `entre-eixos.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `assets.md`
- `6-drops-clinicos.webp`
- `caixa-clinica-do-mes.webp`
- `hero-estetica-visceral.webp`
- `curso-clube.webp`
- `LOGO-ICON.ico`
- `logo-icon.webp`
- `mapa-clinico.webp`
- `um-corpo-multiplos-sistemas.webp`
- `professora-bianca-mendes.webp`
- `brand-spec.md`
- `drawing-2026-08-16T03-46-25-772Z.png`

## Coding checklist for AI tools
1. Inspect `entre-eixos.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
